...
describe("CategoriesTemplate", () => {
  ...
  test("renders correctly", () => {
    const tree = testUtils.createSnapshotsRenderer(<CategoriesTemplate />).toJSON();
  ...
  test("head renders correctly", () => {
    ...
    expect(testUtils.getMeta("twitter:title")).toEqual("Categories - Blog by Baker Moran");
    expect(testUtils.getMeta("og:title")).toEqual("Categories - Blog by Baker Moran");
